...
fn tls12_widget() -> Paragraph<'static> {
    ...
    let lines: Vec<Line> = vec![
        ...
        Line::from(vec![b("  │                          │")]),
        // ① ClientHello
        Line::from(vec![a("① ├──── ClientHello ─────────►│")]),
        Line::from(vec![b("  │                          │")]),
        // ② ServerHello
        Line::from(vec![a("  │◄──── ServerHello ──────────┤"), Span::raw(" ②")]),
        Line::from(vec![b("  │                          │")]),
        // ③ ServerCertificate (plaintext)
        Line::from(vec![a("  │◄──── ServerCert ───────────┤"), Span::raw(" ③")]),
        Line::from(vec![b("  │                          │")]),
        ...
        Line::from(vec![e("  │◄──── Svr Finished ───────────┤"), e(" ⑫E")]),
        Line::from(vec![b("  │                          │")]),
        // ⑬ Application Data (encrypted)
        Line::from(vec![e("⑬ ├◄─── App Data ──────────────►│  E")]),
        Line::from(vec![b("  │                          │")]),
    ];
...
fn tls13_widget() -> Paragraph<'static> {
    ...
    let lines: Vec<Line> = vec![
        ...
        Line::from(vec![e("  │◄── Certificate ────────┤"), e(" ③E")]),
        Line::from(vec![e("  │   (EncExt+Cert+Verify) │")]),
        Line::from(vec![b("  │                    │")]),
        // ④ ClientFinished (encrypted)
        Line::from(vec![e("④ ├── Clt Finished ─────►│  E")]),
        Line::from(vec![b("  │                    │")]),
